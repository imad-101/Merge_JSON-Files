...
const TermsOfUse = () => {
  return (
    <div className="container p-8 border my-7 w-[22rem] sm:w-2/3 mx-auto rounded-xl">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-2">
          Service Features &amp; Usage Guidelines
        </h2>
        <ul className="list-disc pl-6 text-gray-700">
          ...
          <li>
            Strictly prohibited: Processing sensitive/copyrighted data through
            any tools
          </li>
        </ul>
      </section>
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6 mt-2 text-gray-700">
          ...
          <li>HTTPS encryption across all tool interfaces</li>
          <li>Local browser memory clearance post-processing</li>
        </ul>
      </section>
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-2">
        ...
        <p className="text-gray-700">
          While prioritizing uptime for our <strong>JSON merging tool</strong>,
          we maintain best-effort availability for all utilities. Recommended
          practices:
        </p>
        <ul className="list-disc pl-6 mt-2 text-gray-700">
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6 mt-2 text-gray-700">
          ...
          <li>Validate processed JSON output accuracy</li>
          <li>Not reverse-engineer any tool components</li>
        </ul>
      </section>
      <section>
        <h2 className="text-2xl font-semibold mb-2">
        ...
        <p className="text-gray-700">
          Updates will reflect new features across our JSON tools suite. For
          questions about <strong>merging JSON files online</strong> or other
          tools, contact us at&nbsp;
          <a
